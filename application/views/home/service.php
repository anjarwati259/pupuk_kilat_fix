  <section id="services" class="services">
    <div class="container">
      ...
      <div class="section-title" data-aos="fade-up">
        <h2>Check out <span><strong>our services</strong></span></h2>
      </div>
            ...
            <div class="well-middle">
              <div class="single-well">
                ...
                <ul>
                  ...
                  <li>
                    <i class="fa fa-check"></i> Pusat Penelitian Bioteknologi dan Bioindustri Indonesia
                  </li>
                  <li>
                    <i class="fa fa-check"></i> Kementrian Pertanian RI
                  </li>
                </ul>
                <div class="text-center"><a href="<?php echo base_url('home/about') ?>" class="btn-get-started">Selengkapnya</a></div>
              </div>
            </div>
          </div>
          <!-- End col-->
