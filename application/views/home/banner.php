    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active animate__animated animate__fadeInUp">
          <img src="<?php echo base_url()?>assets/img/gambar/bg-01.jpg" class="img-fluid" > 
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Pupuk Organik Cair Terlengkap</h2>
              <p>Pupuk Organik yang mengandung PH9 satu-satunya di Indonesia Pupuk Organik yang mengandung PH9 satu-satunya di Indonesia Pupuk Organik yang mengandung PH9 satu-satunya di Indonesia </p>
