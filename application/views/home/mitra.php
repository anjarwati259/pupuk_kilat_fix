<section id="clients" class="clients">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      ...
      <div class="row scrollmenu" data-aos="fade-up">
    	<table class="table">
		  <thead>
		    <tr>
		      <th scope="col" class="table-secondary">No</th>
		      <th scope="col" class="table-secondary">Nama</th>
		      <th scope="col" class="table-secondary">Kecamatan</th>
		      <th scope="col" class="table-secondary">Kabupaten</th>
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td><?php echo $mitra->kecamatan ?></td>
