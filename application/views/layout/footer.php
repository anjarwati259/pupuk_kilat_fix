<!-- ======= Footer ======= -->
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>About Us</h3>
            <p>
              PT. Agrikultur Gemilang Indonesia bergerak dibidang pemasaran produk brand KILAT untuk pertanian, perikanan dan peternakan berbasis organik
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Kontak</h4>
            <p>
              Jl. Manggis Raya No.11 Jemberlor Patrang, Jember, Jawa Timur<br><br>
              <strong>Phone:</strong> +6281 335 005 334<br>
              <strong>Email:</strong> ptagiofficial@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>PT. Agrikultur Gemilang Indonesia</span></strong>. All Rights Reserved
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a href="https://www.facebook.com/kilatofficial" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/ptagi.official/" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="https://www.youtube.com/channel/UC55i-fOYx2epwRirCODrwEA" class="instagram" class="google-plus"><i class="bx bxl-youtube"></i></a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="<?php echo base_url() ?>assets/vendor/parallax/parallax.js"></script>
